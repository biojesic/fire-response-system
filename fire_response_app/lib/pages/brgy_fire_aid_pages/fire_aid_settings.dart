...
class FireAidSettings extends StatefulWidget {
  const FireAidSettings({super.key});

  @override
  State<FireAidSettings> createState() => _FireAidSettingsState();
}

class _FireAidSettingsState extends State<FireAidSettings> {
  bool notif = true;
  bool theme = false;
