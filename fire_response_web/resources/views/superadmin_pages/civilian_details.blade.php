    ...
    <div class="container w-220 pt-6 ml-21">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <div class="mb-4">
                ...
                <p class="text-gray-800">{{ $civilian->userFirstName }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold text-gray-700">Last Name:</label>
                <p class="text-gray-800">{{ $civilian->userLastName }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold text-gray-700">Email:</label>
                <p class="text-gray-800">{{ $civilian->email }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold text-gray-700">User Address:</label>
                <p class="text-gray-800">{{ $civilian->userAddress }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold text-gray-700">Contact Number:</label>
                <p class="text-gray-800">{{ $civilian->userContactNumber }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold text-gray-700">Birth Date:</label>
                <p class="text-gray-800">{{ $civilian->userBirthDate }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold text-gray-700">Reapplication Count:</label>
                <p class="text-gray-800">{{ $civilian->reapplication_count }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold text-gray-700">ID Image:</label>
                <div class="mb-2">
                    <img src="{{ asset('storage/' . $civilian->id_image) }}" alt="ID Image"
            ...
            <div class="mb-4">
                ...
                <div class="mb-2">
                    <img src="{{ asset('storage/' . $civilian->profile_image) }}" alt="ID Image"
                        class="w-32 h-32 object-cover">
                </div>
            </div>
